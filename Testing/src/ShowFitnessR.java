...
public class ShowFitnessR {
	...
	public static void main(String[] args) {
		...
		if (clientID != -1) {
			...
			// rfitness = RunScene(vrep,
			// clientID,"C:/Users/Rodrigo/Documents/2015-I/Tesis/V-REP/Modular/Maze/MazeBuilderTest.ttt",
			// MaxTime);
	...
	static float[] RunScene(remoteApi vrep, int clientID, String scene,
			int MaxTime) {
		...
		if (out2.getArray()[0] == 0) {
			...
			fitnessout[1] = (out2.getArray()[0] * (100f / 7f))
					+ (float) MaxTime;
		}
